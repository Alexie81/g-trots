...
const styles = StyleSheet.create({
  ...
  actions: { height: 58, flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 8, paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: '#302C33', backgroundColor: Colors.bg, elevation: 14 }, totalPill: { minWidth: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#211F24' }, totalPillText: { color: Colors.textPrimary, fontFamily: 'Inter-Bold', fontSize: 10 }, search: { flex: 1, minWidth: 0, height: 42, flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 13, paddingHorizontal: 10, backgroundColor: '#1B1B1F' }, searchInput: { flex: 1, minWidth: 0, color: Colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 10 }, clearSearch: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: 9, backgroundColor: '#2B282E' }, refresh: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#1B1B1F' },
