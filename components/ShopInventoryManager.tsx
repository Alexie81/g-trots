...
const styles = StyleSheet.create({
  ...
  actions: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: 7, paddingHorizontal: 10, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#302C33', backgroundColor: Colors.bg, elevation: 8 }, totalPill: { minWidth: 42, height: 46, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#211F24' }, totalPillText: { color: Colors.textPrimary, fontFamily: 'Inter-Bold', fontSize: 11 }, search: { flex: 1, minHeight: 46, flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 15, paddingHorizontal: 12, backgroundColor: '#1B1B1F' }, searchInput: { flex: 1, color: Colors.textPrimary, fontFamily: 'Inter-Regular', fontSize: 11 }, clearSearch: { width: 28, height: 28, alignItems: 'center', justifyContent: 'center', borderRadius: 9, backgroundColor: '#2B282E' }, refresh: { width: 46, height: 46, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#1B1B1F' },
