...
export default function ShopPagination({ page, pageSize, total, onPageChange, onPageSizeChange }: {
  page: number;
  pageSize: number;
  total: number;
...
const styles = StyleSheet.create({
  ...
  pageSizeMenu: { flexDirection: 'row', gap: 7, borderTopWidth: 1, borderTopColor: '#302D34', paddingTop: 8, marginTop: 5 },
  pageSizeOption: { minHeight: 36, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, borderWidth: 1, borderColor: '#38353C', borderRadius: 11, backgroundColor: '#242228' },
