...
const styles = StyleSheet.create({
  trigger: { minHeight: 46, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingHorizontal: 11, borderRadius: 15, borderWidth: 1, borderColor: '#376A50', backgroundColor: '#193328' }, triggerCompact: { width: 42, minHeight: 42, paddingHorizontal: 0, borderRadius: 13 }, triggerText: { color: '#BAF1D4', fontSize: 11, fontFamily: 'Inter-SemiBold' },
