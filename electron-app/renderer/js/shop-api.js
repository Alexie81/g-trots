(function () {
  ...
  window.SHOP_API = {
    getDashboardStats: (filters = {}) => call('getDashboardStats', {}, '', 0, filters),
    ...
    getNirExportEstimate: (from, to, includeDocuments) => call('getNirExportEstimate', {}, '', 0, { from, to, include_documents: includeDocuments ? 1 : 0 }),
    ...
    getInventoryExportEstimate: (from, to) => call('getInventoryExportEstimate', json('POST', { from, to })),
    exportInventoryLedger: (from, to) => call('exportInventoryLedger', json('POST', { from, to })),
    ...
    downloadInvoice: (id, format = 'pdf') => call('downloadInvoice', {}, id, 0, { format }),
    getInvoicePublicLink: (id, format = 'pdf') => call('getInvoicePublicLink', {}, id, 0, { format }),
    sendInvoiceEmail: (id) => call('sendInvoiceEmail', json('POST', { invoice_id: id }), id),
    deleteInvoice: (id) => call('deleteInvoice', { method: 'DELETE' }, id),
    prepareShippingNote: (orderId) => call('prepareShippingNote', {}, orderId),
    issueShippingNote: (orderId, payload) => call('issueShippingNote', json('POST', { order_id: orderId, ...payload }), orderId),
    getShippingNote: (id) => call('getShippingNote', {}, id),
    downloadShippingNote: (id) => call('downloadShippingNote', {}, id),
    getShippingNotePublicLink: (id) => call('getShippingNotePublicLink', {}, id),
    sendShippingNoteEmail: (id) => call('sendShippingNoteEmail', json('POST', { shipping_note_id: id }), id),
    deleteShippingNote: (id) => call('deleteShippingNote', { method: 'DELETE' }, id),
    ...
    runSpvWorker: () => call('runSpvWorker', json('POST', {})),
    getShopNotificationSummary: () => call('getShopNotificationSummary'),
    listShopNotifications: (limit = 50, unreadOnly = false) => call('listShopNotifications', {}, '', 0, { limit, unread_only: unreadOnly ? 1 : 0 }),
    markShopNotificationRead: (id = '', all = false) => call('markShopNotificationRead', json('POST', { id, all })),
    ...
    listReceiptLocations: (companyId = '') => call('listReceiptLocations', {}, '', 0, companyId ? { company_id: companyId } : {}),
    createReceiptLocation: (payload) => call('createReceiptLocation', json('POST', payload)),
    updateReceiptLocation: (id, payload) => call('updateReceiptLocation', json('PUT', payload), id),
    deleteReceiptLocation: (id) => call('deleteReceiptLocation', { method: 'DELETE' }, id),
    syncStripeCatalog,
