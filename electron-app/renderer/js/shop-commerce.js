(function () {
  ...
  function productModal() {
    return `<div class="shop-commerce-overlay" id="shop-product-modal" hidden><form class="shop-commerce-modal product-editor" id="shop-product-form"><header><div><small>CRM PRODUSE</small><h2 id="shop-product-modal-title">Produs nou</h2></div><button type="button" data-commerce-close="shop-product-modal">×</button></header><div class="shop-commerce-modal-scroll">
      ...
      ${section('08', 'Siguranta si conformitate', 'Date GPSR, avertismente, documente si garantii. Campurile lipsa raman necompletate.')}
      <label>Adresa producator<textarea id="shop-product-manufacturer-address" rows="2" maxlength="500"></textarea></label>
      <div class="shop-commerce-columns"><label>E-mail producator<input id="shop-product-manufacturer-email" type="email" maxlength="254" /></label><label>Persoana responsabila in UE<input id="shop-product-eu-name" maxlength="180" /></label></div>
      <label>Adresa persoana responsabila in UE<textarea id="shop-product-eu-address" rows="2" maxlength="500"></textarea></label>
      <div class="shop-commerce-columns"><label>E-mail persoana responsabila UE<input id="shop-product-eu-email" type="email" maxlength="254" /></label><label>Marcaj CE<select id="shop-product-ce"><option value="">Necunoscut / necompletat</option><option value="yes">Aplicabil</option><option value="no">Nu se aplica</option></select></label></div>
      <div class="shop-commerce-columns"><label>Model<input id="shop-product-model" maxlength="180" /></label><label>Identificator produs<input id="shop-product-identifier" maxlength="180" /></label></div>
      <label>Avertismente de siguranta in romana<textarea id="shop-product-safety-warnings" rows="4" maxlength="10000"></textarea></label>
      <div class="shop-commerce-columns"><label>Documente de siguranta <small>Un URL https pe linie</small><textarea id="shop-product-safety-documents" rows="4"></textarea></label><label>Documente de conformitate <small>Un URL https pe linie</small><textarea id="shop-product-compliance-documents" rows="4"></textarea></label></div>
      <div class="shop-commerce-columns three"><label>Garantie legala (luni)<input id="shop-product-legal-warranty" type="number" min="0" max="240" value="24" /></label><label>Garantie comerciala (luni)<input id="shop-product-commercial-warranty" type="number" min="0" max="240" placeholder="Optional" /></label><label>Actualizari software pana la<input id="shop-product-software-updates" type="date" /></label></div>
      <div class="shop-commerce-columns"><label>Informatii reparabilitate<textarea id="shop-product-repairability" rows="3"></textarea></label><label>Disponibilitate piese de schimb<textarea id="shop-product-spare-parts" rows="3"></textarea></label></div>
