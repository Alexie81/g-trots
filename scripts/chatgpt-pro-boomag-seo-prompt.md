...
- `description_html`: lungimea se adaptează complexității și intenției de căutare; Google nu are un număr preferat de cuvinte. Folosește ca reper **600–900 de cuvinte pentru produse simple**, **900–1.300 pentru produse tehnice obișnuite** și **1.200–1.800 pentru produse complexe** care necesită explicații reale despre compatibilitate, alegere, instalare și siguranță. Ținta implicită recomandată pentru catalog este **900–1.300 de cuvinte**. Nu prelungi textul doar pentru atingerea limitei și nu scurta o explicație utilă doar pentru a intra în interval. Folosește numai `<p>`, `<strong>`, `<ul>`, `<ol>` și `<li>`. Nu folosi `<h1>`–`<h6>`. Textul trebuie să curgă ca un ghid profesionist, cu liste utile, compatibilitate, alegere, montaj, întreținere, limite și siguranță. Evită paragrafele umplute artificial și repetarea acelorași expresii.
