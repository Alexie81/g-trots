...
<body><main><a class="back" href="/magazin">← Magazin</a><h1>Catalog complet G-Trots</h1><p>${products.length} produse publice, fiecare cu pagină canonică și date structurate Product + Offer. Prețul și stocul de pe pagina produsului sunt sursa finală.</p>${sections}</main><script src="/legal-footer.js?v=20260919-whatsapp-sticky-v4" defer></script></body></html>\n`;
}
