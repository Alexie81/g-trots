...
final class GtrotsInvoiceXlsx
{
    public static function render(array $invoice): string
    {
        ...
        $rows .= shopNirPremiumXlsxRow(1, [1 => shopNirPremiumXlsxCellSpec('', 'string', 1), 3 => shopNirPremiumXlsxCellSpec('G-TROTS · FACTURĂ', 'string', 1), 7 => shopNirPremiumXlsxCellSpec($statusLabel, 'string', 17)], 30);
        $rows .= shopNirPremiumXlsxRow(2, [3 => shopNirPremiumXlsxCellSpec(trim((string)($seller['name'] ?? 'G-Trots România')), 'string', 2), 7 => shopNirPremiumXlsxCellSpec($series . ' ' . $number, 'string', 3)], 27);
        ...
        $rows .= shopNirPremiumXlsxRow(3, [3 => shopNirPremiumXlsxCellSpec($sellerIdentity, 'string', 4), 7 => shopNirPremiumXlsxCellSpec('Emisă: ' . self::dateLabel((string)($invoice['issue_date'] ?? '')), 'string', 4), 9 => shopNirPremiumXlsxCellSpec('Scadență: ' . self::dateLabel((string)($invoice['due_date'] ?? '')), 'string', 4)], 22);
    ...
    private static function styles(string $accent, string $soft, string $accentDark, string $statusColor, string $currency): string
    {
        ...
        return '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">'
            ...
            . '<fonts count="8"><font><sz val="10"/><color rgb="FF242126"/><name val="Aptos"/></font><font><b/><sz val="18"/><color rgb="FFFFFFFF"/><name val="Aptos Display"/></font><font><b/><sz val="10"/><color rgb="FFFFFFFF"/><name val="Aptos"/></font><font><b/><sz val="13"/><color rgb="FF' . $accentDark . '"/><name val="Aptos Display"/></font><font><sz val="9"/><color rgb="FF6F6871"/><name val="Aptos"/></font><font><b/><sz val="9"/><color rgb="FF' . $accentDark . '"/><name val="Aptos"/></font><font><b/><sz val="10"/><color rgb="FF171518"/><name val="Aptos"/></font><font><b/><sz val="12"/><color rgb="FFFFFFFF"/><name val="Aptos Display"/></font></fonts>'
            ...
            . '<xf numFmtId="0" fontId="2" fillId="2" borderId="0" xfId="0" applyFill="1" applyFont="1" applyAlignment="1"><alignment vertical="center"/></xf>'
            ...
            . '<xf numFmtId="0" fontId="4" fillId="4" borderId="0" xfId="0" applyFill="1" applyFont="1" applyAlignment="1"><alignment vertical="center"/></xf>'
