...
class Dompdf
{
    ...
    */
    ...
    public function __construct($options = null)
    {
        ...
        // phar:// paths cannot be resolved by realpath(), although they remain
        // perfectly readable through the stream wrapper.
        $versionFile = realpath(__DIR__ . '/../VERSION') ?: dirname(__DIR__) . '/VERSION';
        if (is_file($versionFile) && ($version = file_get_contents($versionFile)) !== false) {
