...
$brokenImage = realpath(__DIR__ . "/../../lib/res/broken_image.svg")
    ?: dirname(__DIR__, 2) . "/lib/res/broken_image.svg";
if (file_exists($brokenImage)) {
    Cache::$broken_image = $brokenImage;
}
