...
class Options
{
    ...
    */
    ...
    {
        // realpath() returns false for files loaded through PHP's phar:// stream.
        // Keep Dompdf usable from the compact production runtime archive as well
        // as from the regular Composer directory used during development.
        ...
        $ver = "";
        $versionFile = realpath(__DIR__ . '/../VERSION') ?: dirname(__DIR__) . '/VERSION';
