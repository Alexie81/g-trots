...
final class GtrotsShippingNotePdf
{
    ...
    private static function html(array $document): string
    {
        ...
        $stamp = !empty($document['with_stamp']) ? '<div class="stamp"><strong>ȘTAMPILĂ:</strong></div>' : '';
