...
publicAddressAssert(!str_contains($serviceBucharest, 'Str. Humulești') && str_contains($serviceBucharest, 'Momentan nu este publicată o adresă fixă de atelier'), 'Pagina service București confundă încă sediul social cu atelierul.');
