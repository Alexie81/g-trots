...
navigationAssert(str_contains($productTemplate, 'legal-footer.js?v=20260908-nav-v2'), 'Produsele viitoare trebuie să încarce versiunea actuală a navbarului global.');
