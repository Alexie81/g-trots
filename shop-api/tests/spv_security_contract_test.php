...
$requiredActions = ['getSpvConnection', 'beginSpvOAuth', 'testSpvConnection', 'updateSpvSettings', 'disconnectSpv', 'sendInvoiceToSpv', 'runSpvWorker', 'getShopNotificationSummary', 'listShopNotifications', 'markShopNotificationRead'];
