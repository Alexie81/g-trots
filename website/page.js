if (!document.querySelector('script[src*="legal-footer.js"]')) { const legal = document.createElement('script'); legal.src = '/legal-footer.js?v=20260919-whatsapp-sticky-v4'; legal.defer = true; document.head.append(legal); }
...
if (!window.GTrotsFavorites && !document.querySelector('script[src*="favorites.js"]')) {
  ...
  favoritesScript.src = "/favorites.js?v=20260908-nav-v1";
