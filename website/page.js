if (!document.querySelector('script[src*="legal-footer.js"]')) { const legal = document.createElement('script'); legal.src = '/legal-footer.js?v=20260908-nav-v2'; legal.defer = true; document.head.append(legal); }
